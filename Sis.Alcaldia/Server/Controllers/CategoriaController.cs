...
namespace Sis.Alcaldia.Server.Controllers
{
    ...
    public class CategoriaController : ControllerBase
    {
        ...
        public async Task<IActionResult> Guardar([FromBody] CategoriaDTO request)
        {
            ...
            try
            {
                Categorium _categoria = _mapper.Map<Categorium>(request);

                Categorium _categoriaCreada = await _categoriaRepositorio.Crear(_categoria);
        ...
        public async Task<IActionResult> Editar([FromBody] CategoriaDTO request)
        {
            ...
            {
                Categorium _categoria = _mapper.Map<Categorium>(request);
                Categorium _categoriaParaEditar = await _categoriaRepositorio.Obtener(u => u.IdCategoria == _categoria.IdCategoria);
        ...
        public async Task<IActionResult> Eliminar(int id)
        {
            ...
            try
            {
                Categorium _categoriaEliminar = await _categoriaRepositorio.Obtener(u => u.IdCategoria == id);
